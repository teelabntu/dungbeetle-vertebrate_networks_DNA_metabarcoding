...
The settings used in this pipeline are provided as "APSCALE_Settings_12S.xlsx" and "APSCALE_Settings_16S.xlsx".
...
Output files: 12S_OTU_raw.csv; 16S_OTU_raw.csv

## 4. Post-Bioinformatics Filtering

A series of post-bioinformatic filtering steps was applied to remove contamination and low-frequency artefacts (following Drake et al. 2022; code: 4_Post-Bioinformatics_filtering.R):
...
Output files: 12S_OTU_filtered.csv; 16S_OTU_filtered.csv

Output files were processed in Microsoft Excel to remove OTUs that had 0 total reads post-filtering.

Outfile files: 12S_OTU_filtered2.csv; 16S_OTU_filtered2.csv
...
Output files: 12S_OTU_seq_filtered_results.csv; 16S_OTU_seq_filtered_results.csv

BLAST results were filtered using the following criteria (code: 5_BLAST_results_filtering.R):
...
Taxonomy assignments with the following criteria were retained (code: 5_BLAST_results_filtering.R):
...
Output files: 12S_OTU_all_blast_scores; 12S_OTU_assigned_taxonomy_tophit.csv; 16S_OTU_all_blast_scores; 16S_OTU_assigned_taxonomy_tophit.csv
...
Output files: 12S_OTU_matrix.csv; 16S_OTU_matrix.csv

Output files were processed in Microsoft Excel to remove unmatched OTUs.

Output files: 12S_OTU_matrix2.csv; 16S_OTU_matrix2.csv
